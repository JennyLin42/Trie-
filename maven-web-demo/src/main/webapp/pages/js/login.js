			...
			$("#LAY_ucm")
					.append(
							"<div class='layui-tab-item layui-show'>"
									...
									+ "    <div class='layui-input-inline'>"
									+ "      <input type='text' id='username' placeholder='请输入用户名' name='username' required lay-verify='user' autocomplete='off' class='layui-input'>"
									+ "</div>"
									+ "</div>"
		...
		function modifyPassword(){
			...
			.append(
					"<div class='layui-tab-item layui-show'>"
							...
							+ "  </div>"
							+ "  <div class='layui-form-item' style='align:center; margin:0 0 0 70px;'>"
							+ "    <button class='layui-btn' id='modifyPass' lay-filter='modifyPass' lay-submit>确定</button>"
							+"     <button type='reset' class='layui-btn layui-btn-primary'>重置</button>"
							+ "  </div>"
							+ " </div>");
		}
